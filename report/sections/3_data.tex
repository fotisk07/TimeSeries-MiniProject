...
\textbf{High-Frequency Tracking Data:} We utilized the provided sample dataset and supplementary public data from SkillCorner (A-League, 10 Hz) and Last Row (20 Hz). All inputs were converted to the Fitogether format (K-League, 10 Hz), represented as a sequence of 2D coordinates $x_{i, t} \in \mathbb{R}^2$.
\begin{itemize}
